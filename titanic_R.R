#data <-  read.csv("C:\\Users\\sandy\\Dropbox\\Part 0 - Coaching_practice\\titanic\\dataset\\train.csv")
...
train <-read.csv("C:\\Users\\sandy\\Dropbox\\Part 0 - Coaching_practice\\titanic\\dataset\\train.csv", stringsAsFactors = F)
test  <-read.csv("C:\\Users\\sandy\\Dropbox\\Part 0 - Coaching_practice\\titanic\\dataset\\test.csv", stringsAsFactors = F)
